...
for i in range(len(frames2ched)):
    ...
    plt.imsave(f'./{image_path}/ch2_ed_frame_{i}.png', frames2ched[i].squeeze(), cmap='gray')
    plt.imsave(f'./{image_path}/ch4_ed_frame_{i}.png', frames4ched[i].squeeze(), cmap='gray')
    plt.imsave(f'./{mask_path}/ch2_ed_mask_{i}.png', masks2ched[i].squeeze(), cmap='gray')
    plt.imsave(f'./{mask_path}/ch4_ed_mask_{i}.png', masks4ched[i].squeeze(), cmap='gray')
    plt.imsave(f'./{image_path}/ch2_es_frame_{i}.png', frames2ches[i].squeeze(), cmap='gray')
    plt.imsave(f'./{image_path}/ch4_es_frame_{i}.png', frames4ches[i].squeeze(), cmap='gray')
    plt.imsave(f'./{mask_path}/ch2_es_mask_{i}.png', masks2ches[i].squeeze(), cmap='gray')
    plt.imsave(f'./{mask_path}/ch4_es_mask_{i}.png', masks4ches[i].squeeze(), cmap='gray')